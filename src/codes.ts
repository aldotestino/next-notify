export const notificationCode = `import { CheckCircleIcon, ExclamationCircleIcon, InformationCircleIcon, XCircleIcon, XIcon } from '@heroicons/react/outline';
...
export const _appCode = `function App({ Component, pageProps }: AppProps) {
  return (
...
export const registerCode = `const { notify } = useNotify();
...
export const myNotificationCode = `export default const MyNotification: NotificationRenderFunction = ({ title, description, onClose, duration, type }) => {
  return (
...
export const register2Code = `import MyNotification from './MyNotification.tsx';
